...
anno$cutGW <- cut(anno$GW, c(0, 196, 224, 259, Inf), c("<28","28-32", "32-37", ">38"), include.lowest = TRUE)
#cutting the GW on extremely preterm < 28 weeks, Preterm 28-32, Moderate to Late preterm 32-37, Normal 38-42
anno$cutWeight <- cut(anno$weight, c(0, 1500, 2500, 4200, Inf), c("VLBW", "LBW", "NBW", "LGW"), include.lowest = TRUE)
