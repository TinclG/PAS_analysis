...
matclust <- bind_rows(matclust_1, matclust_3)
...
results_PAS_ctrl2$genelabels <- factor(results_PAS_ctrl2$gene_name, levels = ECM_proteoglycans)
...
heeatmap_cell_cell <- makeHeatmap(mat_cell_cell, "GO cell-cell adhesion", dfx)
```
To-do
