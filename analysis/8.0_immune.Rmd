...
PAS_immune <- PAS_immune |>
  ...
  as.matrix()
order <- c("TG.1", "TG.10", "TG.2", "TG.3", "TG.4", "TG.5", "TG.6", "TG.7", "TG.9", "TG.11", "TG.12", "TG.14", "TG.15", "TG.17", "TG.18", "TG.20", "TG.21", "TG.13", "TG.16", "TG.19")
...
res_cibersort <- deconvolute(PAS_immune, qseq, tumor = FALSE)
...
```{r}
res_mcp_counter <- deconvolute(PAS_immune, qseq, tumor = FALSE)
res_mcp_counter %>%
