...
#<!-- VJM: If there is no specific reason to load this unrelated dataset if would delete it! -->
...
#<!-- VJM: This is a little confusing to me, the object "results_PAS_ctrl" is being overwritten three times. I would just stick with one! -->
...
#<!-- VJM: Using the "dplyr::function()" notation can be a bit tedious if there is a lot of functions throughout the code. The conflict prefer package is a nice alternative to specify this stuff once at the beginning of the document. But of course this is totally ok as well ;)  -->
...
clustering_sig_genes <- sigLRT_genes %>% # results_PAS_ctrl?!
  arrange(padj) %>%
  head(n=1000)

#<!-- VJM: Why do you exclude significant genes? - with "head(n=1000)" - I think the trade of to wait a little longer should be worth it taking all of them?! If it does not converge that's another issue ... -->
