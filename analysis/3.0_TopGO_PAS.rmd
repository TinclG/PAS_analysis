...
```{r}
#[]use the gene names instead of ensembl 
...
#write.csv(R_PA@result, "Reactome_PAS_Ctrl_all.csv")
```
## Wiki pathway
...
```
 [] Try with just up an down regulated
 as background use all of the genes that were expressed (from dds class: DESeqDataSet 
